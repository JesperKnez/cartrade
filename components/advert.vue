  ...
  <NuxtLink :to="`/adverts/${id}`">
    <div class="bg-white shadow rounded-lg px-6 py-4">
        <div class="flex justify-between items-start">
            <div>
                <h3 class="text-2xl font-bold flex items-center gap-2">{{merk}} {{model}} <span class="text-base font-medium">{{uitvoering}}</span></h3>
        ...
        <div class="grid grid-cols-3 justify-between gap-4 mt-4">
            ...
            <div class="col-span-2">
                <ul class="list-none">
                    <li class="text-lg font-semibold font-sans">Kenteken: <span class="text-base font-normal">{{kenteken}}</span></li>
                    <li class="text-lg font-semibold font-sans">Bouwjaar: <span class="text-base font-normal">{{bouwjaar}}</span></li>
                    <li class="text-lg font-semibold font-sans">Brandstof: <span class="text-base font-normal">{{brandstof}}</span></li>
                    <li class="text-lg font-semibold font-sans">Kilometerstand: <span class="text-base font-normal">{{kilometerstand}} km</span></li>
                </ul>
